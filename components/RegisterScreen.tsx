  ...
  return (
    <div className="flex min-h-screen flex-col bg-white px-6 py-8">
      <button 
        ...
        className="mb-6 flex h-10 w-10 items-center justify-center rounded-full border border-slate-100 bg-slate-50 text-slate-600 transition-colors hover:bg-slate-100"
      >
      ...
      <div className="flex flex-1 flex-col justify-center">
        <div className="mb-8 animate-fade-in-down">
          <h1 className="text-2xl font-bold text-slate-800 font-kanit">สร้างบัญชีใหม่ (Create Account)</h1>
          <p className="mt-1 text-sm text-slate-500 font-kanit">สมัครสมาชิกเพื่อรับสิทธิพิเศษมากมาย</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4 animate-fade-in-up">
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-600 font-kanit">ชื่อ-นามสกุล (Full Name)</label>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-600 font-kanit">อีเมล (Email Address)</label>
            <div className="relative">
          ...
          <div className="flex items-start gap-2 pt-2">
            <input type="checkbox" id="terms" className="mt-1 rounded border-slate-300 text-[#0056b3] focus:ring-[#0056b3]" required />
            <label htmlFor="terms" className="text-xs text-slate-500 font-kanit leading-relaxed">
          ...
          <button 
            type="submit"
            className="mt-4 w-full rounded-xl bg-gradient-to-r from-[#0056b3] to-[#00a8e8] py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-500/30 transition-all hover:scale-[1.02] active:scale-95 font-kanit"
          >
