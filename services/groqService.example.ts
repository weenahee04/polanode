/**
 * ตัวอย่าง Groq Service สำหรับทดแทน Gemini
 * 
 * วิธีใช้:
 * 1. npm install groq-sdk
 * 2. ตั้งค่า GROQ_API_KEY ใน .env.local
 * 3. เปลี่ยน import ใน App.tsx จาก geminiService เป็น groqService
 */
...
export const analyzeMedicalImage = async (base64Data: string, mimeType: string): Promise<{ 
  ...
  // ⚠️ หมายเหตุ: Groq ไม่รองรับ Vision/Image Analysis
  // ต้องใช้ Gemini หรือ API อื่นสำหรับ image analysis
  return { 
    ...emptyResult, 
    text: "Groq API ไม่รองรับการวิเคราะห์รูปภาพ กรุณาใช้ Gemini API สำหรับฟีเจอร์นี้" 
  };
};
